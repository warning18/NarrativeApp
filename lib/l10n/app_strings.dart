...
const Map<String, Map<AppLanguage, String>> _strings = {
  ...
  'tut_boat_title': {
    AppLanguage.en: 'The boat',
    AppLanguage.fr: 'Le bateau',
  },
  'tut_voyage_title': {
  ...
  'tut_camp_3': {
    AppLanguage.en: 'The harbour. Your boat sails from here to other ports.',
    AppLanguage.fr: "Le port. Votre bateau part d'ici vers d'autres ports.",
  },
  'tut_camp_4': {
    AppLanguage.en:
  ...
  'tut_skills_2': {
    AppLanguage.en:
        'Every skill you can learn. Unlock one, then upgrade it up to tier 3. A padlock means it belongs to another race or calling.',
    AppLanguage.fr:
        'Toutes les compétences possibles. Débloquez-en une, puis améliorez-la jusqu’au rang 3. Un cadenas : elle appartient à une autre race ou vocation.',
  },
  'tut_skills_3': {
  ...
  'tut_boat_1': {
    AppLanguage.en:
        'The Rusty Eel. Fit parts from the shipwright into her slots to make her stronger.',
    AppLanguage.fr:
        'La Rusty Eel. Installez les pièces du charpentier dans ses emplacements pour la renforcer.',
  },
  'tut_boat_2': {
    AppLanguage.en:
        'Choose a port on the chart to set sail. Each port has its own expeditions.',
    AppLanguage.fr:
        'Choisissez un port sur la carte pour appareiller. Chaque port a ses propres expéditions.',
  },
  'tut_voyage_1': {
    AppLanguage.en:
  ...
  'tut_town_1': {
    AppLanguage.en:
        'A port of call: rest, trade in its shops and set out on the expeditions nearby.',
    AppLanguage.fr:
        'Une escale : reposez-vous, commercez et partez pour les expéditions voisines.',
  },
  'tut_shop_1': {
