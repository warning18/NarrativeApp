...
const Map<String, Map<AppLanguage, String>> _strings = {
  ...
  'recruited_prefix': {AppLanguage.en: 'recruited', AppLanguage.fr: 'recruté(e)'},
  'camp_title': {AppLanguage.en: 'Camp', AppLanguage.fr: 'Campement'},
  'roster_section': {AppLanguage.en: 'Roster', AppLanguage.fr: 'Compagnons'},
  'active_party_label': {AppLanguage.en: 'Active Party', AppLanguage.fr: 'Groupe actif'},
  ...
  'requires_house_prefix': {AppLanguage.en: 'Requires', AppLanguage.fr: 'Nécessite'},
  'party_at_capacity': {
  ...
  'chapter_breakdown_label': {AppLanguage.en: 'By Chapter', AppLanguage.fr: 'Par chapitre'},
  'by_location_label': {AppLanguage.en: 'By Location', AppLanguage.fr: 'Par lieu'},
  'by_mood_label': {AppLanguage.en: 'By Mood', AppLanguage.fr: 'Par ambiance'},
  'filter_runs_label': {AppLanguage.en: 'Filter runs', AppLanguage.fr: 'Filtrer les parties'},
  'ending_filter_all': {AppLanguage.en: 'All endings', AppLanguage.fr: 'Toutes les fins'},
  'min_chapter_filter_label': {AppLanguage.en: 'Min. chapter', AppLanguage.fr: 'Chapitre min.'},
  'any_label': {AppLanguage.en: 'Any', AppLanguage.fr: 'Tous'},
  'stuck_only_filter': {AppLanguage.en: 'Stuck only', AppLanguage.fr: 'Bloquées seulement'},
  ...
  'export_failed_prefix': {AppLanguage.en: 'Export failed', AppLanguage.fr: "Échec de l'export"},
